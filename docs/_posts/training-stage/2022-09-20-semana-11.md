...
Una vez instalado NAF, ¿cómo puedo añadirlo a la escena? Marta me ha indicado que he crear una carpeta en JavaScript editor e introducir todo lo que sea necesario para luego añadir en 'index.html' los enlaces necesarios. 

#### Introducción del motor de físicas AMMO

Por otro lado, no localizo la ubicación del motor de físicas que ha sido utilizado hasta ahora.
