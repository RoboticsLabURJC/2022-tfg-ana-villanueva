...
1. var interationsObj --> simulation\aframe-components\renderInterationsComponent.js *Contador: no coincide con el código de Natalia*
2. function extendAframe --> simulation\function.js  *AFRAME.registerComponent*